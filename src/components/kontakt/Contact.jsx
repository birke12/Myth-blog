              ...
              <form onSubmit={handleSubmit} className={styles.form1}>
                <div className={styles.textContainer}>
                  ...
                  <div className={styles.newsText}>
                    ...
                    don’t hesitate to send an email to contact@ancientjourney.com
                    or fill out the contact form. We are also happy to send our
                    media kit with statistics from our Danish travel blog Ancient
                    Journey, our international travel blog Ancient Journey Abroad,
                    and our Instagram profile @ancientjourney. Write a few lines
                    about your thoughts or proposals, and we will get back to you
                    as soon as possible.
                  </div>
                </div>
