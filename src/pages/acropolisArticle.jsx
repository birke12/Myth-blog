    ...
    <article className={styles.introductionContainer}>
      <div className={styles.innerContainer}>
        ...
        <h1 className={styles.heading}>
          {/* What is Ancient journeys */} {articleHeader}
        </h1>
        <img
        ...
        />
        <img src={articleImg} alt={articleAlt} />
        {/* Text Content */}
        ...
        <p className={styles.text}>
          ...
          Ancient Journeys takes you on an exploration of the wonders of human
          civilization that have withstood the test of time. Our journey begins
          in the golden sands of Egypt, where the Great Pyramids rise
